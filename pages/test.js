import { useTheme, Container, Card, Grid, Button, Row, Text, Spacer } from "@nextui-org/react";
...
export default ()=>{
    ...
    function SetSelectVal(idx, param_val) {
        console.log(idx, param_val);
        click_result[idx] = param_val;
    }
                ...
                <Card css={{ mw: "100%" }}>
                    ...
                    <Card.Footer css={{width: "98%"}} >
                        <Row justify="flex-end">
                            <RadioComponent number={number}  SetSelectVal={SetSelectVal}/>
                        </Row>
                    </Card.Footer>
                </Card>
            </Grid>
    ...
    return (
        <div className="content">
            <Container css={{pt: '50px'}}>
                <Card css={{ mw: "100%", $$cardColor: '$colors$gradient', mt: '5%' }}>
                    <Card.Body>
            ...
            <Spacer y={0.5} />
            <Button size="xl" onPress={doneTest}>결정</Button>
        </div>
    )
}