...
function TestHandler() {
    ...
    function AddAsks() {
        const asks = {
            ...
            '44' : {text: '배워보지 못한 언어로 사람들에게 하나님이 주신 메시지를 말해준다.'},
            ...
            '55' : {text: '연구나 경험을 통해서 하나님이 사용하시는 주요 정책이나 기술을 인식할 수 있다.'},
            '56' : {text: '어려움이나 고통 가운데 있던 사람들이 찾아와서 도움과, 치료와 위로가 되었다고 한다.'},
            '57' : {text: '사탄에게 고통을 당하고 있는 사람에게 확신을 가지고 담대하게 선포할 수 있다.'},
            '58' : {text: '사역을 위해 헌금을 해야 한다고 결심을 하면 그 필요한 돈이 생긴다.'},
            ...
            '80' : {text: '성경의 진리를 더 배우기 위해 성경을 읽고 연구한다.'},
            ...
            '91' : {text: '타인을 설득하지 않아도 임무 완수를 위해 그들에게 방향을 제시해 줄 수 있다.'},
            '92' : {text: '하나님은 삶의 과정과 환경에서 나를 초자연적 일을 행하는 도구로 쓰신다.'},
            '93' : {text: '다른 사람의 병이 낫기를 위하여 기도한다.'},
            '94' : {text: '방언으로 메시지를 선포할 때 그 내용이 통역 되었으면 좋겠다고 생각한다.'},
